...
const getCourses = (course : string): courseData => {
  const courses:{[course:string]:courseData} = {
    ...
    iot:{
      ...
      quarters:[
        {
          name : "AC-351: Ambient Computing with Voice Assistants and Matter Protocol Devices",
