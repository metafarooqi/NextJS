'use client';
import { VStack,Text, Container, Flex, HStack } from '@chakra-ui/react'
...
function page() {
  return (
    <>
      <Container maxW="1400" mt={'80px'} mb={'150px'}>
        <HStack spacing={10}>
          <Image src={president} alt="Dr. Arif Alvi" style={{height:"350px !important"}} />
